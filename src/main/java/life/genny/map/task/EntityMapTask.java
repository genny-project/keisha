...
public abstract class EntityMapTask<K, V> {
  ...
  public static Comparator<Map.Entry> descendingComparator;
  ...
  protected PagingPredicate<K, V> getPagesDescendingOrder(int pageSize) {
    return new PagingPredicate(descendingComparator, pageSize);
  }
  
  protected abstract Comparator<Entry> descendingComparator();
